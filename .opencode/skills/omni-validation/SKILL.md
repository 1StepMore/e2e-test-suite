...
description: Validate the Omni Suite against its 119-scenario library (agent-user conformance + human-quality conformance). List/run/check scenarios, read the director report, audit coverage. Tier-1 runs are hermetic (no LLM keys).
---
